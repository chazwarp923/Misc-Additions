...
public class ResearchItem {
	...
	/**
	 * This is the same as isHidden, except it cannot be discovered with
	 * knowledge fragments, only scanning.
	 */
	...
	public ResearchItem(String key, String category, AspectList tags, int col,
			int row, int complex, ResourceLocation icon) {
		this.key = key;
		this.category = category;
		this.tags = tags;
	...
	public ResearchItem(String key, String category, AspectList tags, int col,
			int row, int complex, ItemStack icon) {
		this.key = key;
		this.category = category;
		this.tags = tags;
		this.icon_item = icon;
