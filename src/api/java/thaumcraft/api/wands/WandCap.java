...
public class WandCap {
	...
	public WandCap(String tag, float discount, List<Aspect> specialAspects,
			float discountSpecial, ItemStack item, int craftCost) {
		this.setTag(tag);
		this.baseCostModifier = discount;
	...
	/**
	 * The research a player needs to have finished to be able to craft a wand
	 * with this cap.
	 */
