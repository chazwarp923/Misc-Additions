...
public class TileEntityHoppingBuffer extends TileEntity implements IHopper {
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		for (int i = 0; i < tagList.tagCount(); i++) {
			NBTTagCompound item = (NBTTagCompound)tagList.getCompoundTagAt(i);
