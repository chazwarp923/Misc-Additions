...
public class ModItems {
	...
	public static Item axeLumberDiamond = new ItemLumberAxe(
			Item.ToolMaterial.EMERALD);

	public static void registerItems() {
		GameRegistry.registerItem(axeLumberIron, "Iron "
				+ ItemInfo.LUMBER_AXE_KEY);
		GameRegistry.registerItem(axeLumberDiamond, "Diamond "
				+ ItemInfo.LUMBER_AXE_KEY);
	}
}
